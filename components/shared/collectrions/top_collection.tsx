...
import { collection_data } from '../../../data/shared/collection_data';
import HeadLine from '../headLine';
import Image from 'next/image';

const Top_collection = () => {
	const [timeActiveText, setTimeActiveText] = useState<string>('last 7 days');
							...
							return (
								...
								>
									<figure className="mr-4 shrink-0">
										<Link legacyBehavior href={'/collection/' + itemLink} >
